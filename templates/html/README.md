...
- **Link to another Pages document**: Use `target="_blank" rel="noopener noreferrer"` so the link survives embedded webviews (Pages blocks framing); keep same-page `#fragment` anchors default. See "Cross-page links" in `references/html-rendering.md`
