...
A share is unprotected by default. `--password` generates a 22-character,
128-bit password; `--password-stdin` reads a provided 8–1024 byte password
without placing it in argv. Both explicit secret-returning modes print the
